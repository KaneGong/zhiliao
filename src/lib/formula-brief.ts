...
function sanitizePositiveMarketingText(text: string): string {
  return text
    .replace(/原料合规性明确|合规性明确|合规性最清晰|合规性清晰|合规清晰|法规最清晰|法规清晰|法规明确|法规路径清晰|合规路径清晰|合规无忧|完全合规|已验证/g, "法规边界需按目标食品类别复核")
    ...
    .replace(/辅助降血脂|降血脂|保护心血管|预防三高|降血压|高血压治疗/g, "血脂/心血管相关功能声称")
    .replace(/治疗脱水|医疗补液|快速恢复体能|快速恢复|缓解疲劳/g, "医疗化恢复/抗疲劳声称")
    .replace(/解酒|醒酒|护肝|保肝|保护肝脏|降低酒精伤害|酒精代谢/g, "饮酒功效声称")
